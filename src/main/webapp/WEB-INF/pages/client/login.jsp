...
<body>
	...
	<div class="login-page">
		<div class="form">
			...
			<c:if test="${param.disable != null}">
				<div class="alert alert-danger">
					<p>Tài khoản đã bị khóa, vui lòng liên hệ quản trị viên</p>
				</div>
			</c:if>
			...
			<p class="message" style="font-size: 18; padding-top:10px"><a href="<c:url value='/forgot_password'/> ">Quên mật khẩu</a></p>
		</div>
	</div>
