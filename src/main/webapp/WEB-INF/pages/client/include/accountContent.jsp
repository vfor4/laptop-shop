		...
		<div class="row">
			...
			<div class="col-md-10">
				...
				<h3 style="line-height: 2;">
					<span style="font-weight: bold">Họ tên: </span> <span id="oldName">${user.getHoTen()}</span></h3>
				<h3 style="line-height: 2;">
					<span style="font-weight: bold">Số điện thoại: </span><span id="oldPhone">${user.getSoDienThoai()}</p></h3>
				<h3 style="line-height: 2;">
					<span style="font-weight: bold">Email: </span>${user.getEmail()}</h3>
				<h3 style="line-height: 2;">
					<span style="font-weight: bold"> Địa chỉ: </span><span id="oldAddress">${user.getDiaChi()}</span></h3>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="form-group ">
						<label id="notChangeWarning" style="color: red"></label> 
						<br>
						<label style="line-height: 2">Họ tên khách hàng*:</label><br>
						<label id="nameWarning" style="color: red"></label> <input
							class="form-control" id="name" name="name" type="text" value="${user.getHoTen()}">
