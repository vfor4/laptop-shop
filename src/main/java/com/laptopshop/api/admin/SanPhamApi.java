...
public class SanPhamApi {
	...
	@GetMapping("/top5")
	public ResponseObject findTop5BestSeller(@RequestParam int month){
		ResponseObject responseObject = new ResponseObject();
		List<TopSanPham> Top5BestSellers =  sanPhamService.findTop5BestSellersByMonth(month);
		responseObject.setData(Top5BestSellers);
