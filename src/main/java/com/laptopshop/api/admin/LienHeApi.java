...
public class LienHeApi {
	...
	public Page<LienHe> getLienHeByFilter(@RequestParam(defaultValue = "1") int page,
			@RequestParam String trangThaiLienHe, @RequestParam String tuNgay, @RequestParam String denNgay, HttpServletRequest request)
			throws ParseException {
				// System.out.println(request.getCookies() == null ? "ket qua: null roi" : "ket qua: "+request.getCookies()[0].getName());
