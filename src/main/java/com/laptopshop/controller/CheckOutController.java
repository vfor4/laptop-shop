...
public class CheckOutController {
	...
	public String thankyouPage(@ModelAttribute("donhang") DonHang donhang ,HttpServletRequest req,
		...
		// JSONObject jsonObj = new JSONObject(String.valueOf(donhang.getDiaChiNhan()));

		// StringBuilder diaChiNhanHang = new  StringBuilder(jsonObj.getString("address"));
		// diaChiNhanHang.append(" - ").append(jsonObj.getString("wardName"))
		// .append(" - ").append(jsonObj.getString("districtName"))
		// .append(" - ").append(jsonObj.getString("provinceName"));
	...
	public ModelAndView  showTest(){
        ...
        modelAndView.setViewName("oke.html");
        return modelAndView;
	}
